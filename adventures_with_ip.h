...
#define BUTTON_BASE XPAR_GPIO_1_BASEADDR
#define SWITCH_BASE XPAR_GPIO_2_BASEADDR
#define LED_BASE XPAR_LED_CONTROLLER_0_S00_AXI_BASEADDR
#define BUTTON_ID XPAR_GPIO_1_DEVICE_ID
#define SWITCH_ID XPAR_GPIO_2_DEVICE_ID
